...
map.getView().fit([478498.381257, 5671765.947607, 501819.103728, 5683850.479370], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (27 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Dies ist mein erstes WebGIS';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_gadm41_deu__adm_adm_4_EPSG_25832_2,
    colName: 'NAME_4',
    zoom: 10,
    collapsed: true,
    map: map
